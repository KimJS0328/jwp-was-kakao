...
public class HttpRequestTest {
    ...
    void post요청시_사용자를_생성한다() {
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:8080/user/create",
            "userId=1&password=password&name=Javajigi&email=javajigi%40slipp.net", String.class);
